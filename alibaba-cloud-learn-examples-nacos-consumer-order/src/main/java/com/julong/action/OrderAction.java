...
public class OrderAction {
	...
	public CommonResult<PaymentInfo> savePayment(@RequestBody PaymentInfo paymentInfo){
		return this.restTemplateImpl.postForObject("http://alibaba-cloud-learn-examples-provider-payment/payment/save",paymentInfo, CommonResult.class);
	}
    ...
    public String echoAppName(){
        ...
        ServiceInstance serviceInstance = loadBalancerClient.choose("alibaba-cloud-learn-examples-provider-payment");
